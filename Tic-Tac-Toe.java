...
public class Tic-Tac-Toe {
    ...
    public Tic-Tac-Toe(int num, char[][] array){
        number = num;
        Array = array;
    }
    ...
    public static void main(String[] args) {
        ...
        Tic-Tac-Toe tableau = new Tic-Tac-Toe(num, array);
        
        for (int a = 0; a < 3; a++){
            for (int b = 0; b < 3; b ++){
                    do{  
                    //Input of the shoot the player hase to make 
                    str = JOptionPane.showInputDialog(null, "Enter number where you want to play.\n" + tableau.display(display));
